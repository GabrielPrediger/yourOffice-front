            ...
            <Flex justifyContent="space-between" px="6rem" pt="10">
                <Flex>
                    <Menu>
                        ...
                        <MenuList>
                            <MenuItem _hover={{ background: theme.background.filtroHoverSelected}}>Tipo crescente</MenuItem>
                            <MenuItem _hover={{ background: theme.background.filtroHoverSelected}}>Tipo decrescente</MenuItem>
                        </MenuList>
                    </Menu>
                </Flex>
